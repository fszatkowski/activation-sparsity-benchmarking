...
WORKDIR="${BASE_DIR}/input_intermediate_${LIMIT}"

# Define commands per task (using {param} and {script_dir} as placeholders)
declare -A TASK_CMDS

TASK_CMDS[humaneval]="accelerate launch ../../../scripts/llada_top_p_at_diff_inp_int.py --tasks humaneval --model llada_dist --confirm_run_unsafe_code --model_args \"model_path=GSAI-ML/LLaDA-8B-Base,gen_length=1024,steps=1024,block_length=1024,param={param},script_dir={script_dir}\""
TASK_CMDS[mbpp]="accelerate launch ../../../scripts/llada_top_p_at_diff_inp_int.py --tasks mbpp --model llada_dist --confirm_run_unsafe_code --model_args \"model_path=GSAI-ML/LLaDA-8B-Base,gen_length=1024,steps=1024,block_length=1024,param={param},script_dir={script_dir}\""
TASK_CMDS[arc_challenge]="accelerate ../../../scripts/launch llada_top_p_at_diff_inp_int.py --tasks arc_challenge --num_fewshot 0 --model llada_dist --batch_size 8 --model_args \"model_path=GSAI-ML/LLaDA-8B-Base,cfg=0.5,is_check_greedy=False,mc_num=128,param={param}\""
TASK_CMDS[piqa]="accelerate launch ../../../scripts/llada_top_p_at_diff_inp_int.py --tasks piqa --num_fewshot 0 --model llada_dist --batch_size 8 --model_args \"model_path=GSAI-ML/LLaDA-8B-Base,cfg=0.5,is_check_greedy=False,mc_num=128,param={param}\""
TASK_CMDS[mmlu]="accelerate launch ../../../scripts/llada_top_p_at_diff_inp_int.py --tasks mmlu --num_fewshot 5 --model llada_dist --batch_size 1 --model_args \"model_path=GSAI-ML/LLaDA-8B-Base,cfg=0.0,is_check_greedy=False,mc_num=1,param={param}\""
TASK_CMDS[winogrande]="accelerate launch ../../../scripts/llada_top_p_at_diff_inp_int.py --tasks winogrande --num_fewshot 5 --model llada_dist --batch_size 8 --model_args \"model_path=GSAI-ML/LLaDA-8B-Base,cfg=0.0,is_check_greedy=False,mc_num=128,param={param}\""
TASK_CMDS[ceval-valid]="accelerate launch llada_top_p_at_diff_inp_int.py --tasks ceval-valid --num_fewshot 5 --model llada_dist --batch_size 1 --model_args \"model_path=GSAI-ML/LLaDA-8B-Base,cfg=0.0,is_check_greedy=False,mc_num=1,param={param}\""
TASK_CMDS[cmmlu]="accelerate launch ../../../scripts/llada_top_p_at_diff_inp_int.py --tasks cmmlu --num_fewshot 5 --model llada_dist --batch_size 1 --model_args \"model_path=GSAI-ML/LLaDA-8B-Base,cfg=0.0,is_check_greedy=False,mc_num=1,param={param}\""
TASK_CMDS[gpqa_main_n_shot]="accelerate launch ../../../scripts/llada_top_p_at_diff_inp_int.py --tasks gpqa_main_n_shot --num_fewshot 5 --model llada_dist --batch_size 8 --model_args \"model_path=GSAI-ML/LLaDA-8B-Base,cfg=0.5,is_check_greedy=False,mc_num=128,param={param}\""
TASK_CMDS[hellaswag]="accelerate launch ../../../scripts/llada_top_p_at_diff_inp_int.py --tasks hellaswag --num_fewshot 0 --model llada_dist --batch_size 8 --model_args \"model_path=GSAI-ML/LLaDA-8B-Base,cfg=0.5,is_check_greedy=False,mc_num=128,param={param}\""
