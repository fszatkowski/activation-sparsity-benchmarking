...
model_setups=(
    "google/gemma-2-2b gemma2-2b/input lm_eval/sparsification_configs/gemma2-2b_input.json"
    "google/gemma-2-2b gemma2-2b/intermediate lm_eval/sparsification_configs/gemma2-2b_intermediate.json"
    "google/gemma-2-2b gemma2-2b/gate lm_eval/sparsification_configs/gemma2-2b_gate.json"
    "google/gemma-2-2b gemma2-2b/up_proj lm_eval/sparsification_configs/gemma2-2b_up_proj.json"
)
sparsity_setups=(
    "topp 0.999"
    "topp 0.99"
...
for params in "${model_setups[@]}"; do
    ...
    for sparsity_setup in "${sparsity_setups[@]}"; do
        ...
        # for task in gsm8k ifeval mmlu_redux_generative; do
