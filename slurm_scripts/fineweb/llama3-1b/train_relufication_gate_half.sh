...
python train/main.py \
    ...
    --relufication_target_modules layers.4.mlp.act_fn layers.5.mlp.act_fn layers.6.mlp.act_fn layers.7.mlp.act_fn layers.8.mlp.act_fn layers.9.mlp.act_fn layers.10.mlp.act_fn layers.11.mlp.act_fn \
