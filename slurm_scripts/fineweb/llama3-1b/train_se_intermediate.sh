...
python train/main.py \
    ...
    --run_name llama3-1b-fineweb-s${num_samples}-intermediate-sparsification-${sparsity_loss}-w-${sparsity_weight}-nepochs-${num_epochs}-bs-${actual_batch_size}-lr-${lr} \
    ...
    --logging_steps 1 \
    --report_to wandb \
    --wandb_tags fineweb-s${num_samples}-intermediate-sparsification
