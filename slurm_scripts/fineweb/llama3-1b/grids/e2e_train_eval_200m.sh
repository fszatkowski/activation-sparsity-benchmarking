...
hyperparams=(
    "1e-6 llama3-1b-fineweb-200m-lr-1e-6"
    "3e-6 llama3-1b-fineweb-200m-lr-3e-6"
    "5e-6 llama3-1b-fineweb-200m-lr-5e-6"
    "1e-5 llama3-1b-fineweb-200m-lr-1e-5"
    "3e-5 llama3-1b-fineweb-200m-lr-3e-5"
)
...
for params in "${hyperparams[@]}"; do
    ...
    output_dir=output_models/FineWeb/Llama-3.2-1B/baseline-s${num_samples}-bs-${actual_batch_size}-lr-${lr}
