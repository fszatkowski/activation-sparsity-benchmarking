...
hyperparams=(
    "5e-6 hard llama3-1b-fineweb-500m-gate-relufication-hard"
)
...
for params in "${hyperparams[@]}"; do
    ...
    output_dir=output_models/FineWeb-500M/Llama-3.2-1B/gate-relufication-${relufication_mode}-s${num_samples}-bs-${actual_batch_size}-lr-${lr}
